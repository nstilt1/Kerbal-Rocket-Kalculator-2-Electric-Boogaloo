...
pub static OR_2009_2013_ENGINES: LazyLock<[Engine; NUM_ENGINES]> = LazyLock::new(|| init_orbital_rocketry_2009_2013_engines());

#[rustfmt::skip]
fn init_orbital_rocketry_2009_2013_engines() -> [Engine; NUM_ENGINES] {
    let engines = [
        Engine::new(
            "Merlin 1A", // Engine 0
            false,
