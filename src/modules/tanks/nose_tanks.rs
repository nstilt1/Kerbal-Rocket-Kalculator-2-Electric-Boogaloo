...
mod tests {
    ...
    fn delta_v_nosecone_test() {
        ...
        let wet_mass = dry_mass + num_tanks_f64 * cyl_volume * cyl_fuselage.utilization * engine.fuel_mix.density() + num_tanks_f64 * nose_volume * nose_fuselage.utilization * engine.fuel_mix.density();
